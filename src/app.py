...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and compete in weekly soccer matches",
    ...
    "Drama Club": {
        "description": "Practice acting, stage production, and improvisation",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["ethan@mergington.edu", "grace@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions through hands-on challenges",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ari@mergington.edu", "noah@mergington.edu"]
    },
    "Debate Team": {
